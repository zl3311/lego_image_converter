"""Tile data files and loader utilities.

This subpackage contains CSV data files for tile colors, palettes, and elements,
...
Functions:
    get_colors_for_set: Get Color → Element mapping for a specific palette.
    get_all_colors: Get all colors (optionally filtered to standard).
    get_set_dimensions: Get (width, height) for a palette's canvas.
    get_set_info: Get full info dict for a palette.
